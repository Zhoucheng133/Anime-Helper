import{c as x,d as N}from"./index.browser-CRTWgEnj.js";import{G as F,c as f,o as i,h as P,m as o,B as $,s as b,f as s,r as p,w as h,S as w,a as g,Q as u,U as E,T as U,n as v,V as L,W as z,X as T,Y as j,R as O,P as y,F as V,A as R,i as C,t as I}from"./index-Dlzrg73N.js";var k={name:"ChevronUpIcon",extends:F};function M(e,n,a,t,d,r){return i(),f("svg",o({width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg"},e.pti()),n[0]||(n[0]=[P("path",{d:"M12.2097 10.4113C12.1057 10.4118 12.0027 10.3915 11.9067 10.3516C11.8107 10.3118 11.7237 10.2532 11.6506 10.1792L6.93602 5.46461L2.22139 10.1476C2.07272 10.244 1.89599 10.2877 1.71953 10.2717C1.54307 10.2556 1.3771 10.1808 1.24822 10.0593C1.11933 9.93766 1.035 9.77633 1.00874 9.6011C0.982477 9.42587 1.0158 9.2469 1.10338 9.09287L6.37701 3.81923C6.52533 3.6711 6.72639 3.58789 6.93602 3.58789C7.14565 3.58789 7.3467 3.6711 7.49502 3.81923L12.7687 9.09287C12.9168 9.24119 13 9.44225 13 9.65187C13 9.8615 12.9168 10.0626 12.7687 10.2109C12.616 10.3487 12.4151 10.4207 12.2097 10.4113Z",fill:"currentColor"},null,-1)]),16)}k.render=M;var G={root:"p-accordioncontent",content:"p-accordioncontent-content"},Q=$.extend({name:"accordioncontent",classes:G}),W={name:"BaseAccordionContent",extends:b,props:{as:{type:[String,Object],default:"DIV"},asChild:{type:Boolean,default:!1}},style:Q,provide:function(){return{$pcAccordionContent:this,$parentInstance:this}}},K={name:"AccordionContent",extends:W,inheritAttrs:!1,inject:["$pcAccordion","$pcAccordionPanel"],computed:{id:function(){return"".concat(this.$pcAccordion.id,"_accordioncontent_").concat(this.$pcAccordionPanel.value)},ariaLabelledby:function(){return"".concat(this.$pcAccordion.id,"_accordionheader_").concat(this.$pcAccordionPanel.value)},attrs:function(){return o(this.a11yAttrs,this.ptmi("root",this.ptParams))},a11yAttrs:function(){return{id:this.id,role:"region","aria-labelledby":this.ariaLabelledby,"data-pc-name":"accordioncontent","data-p-active":this.$pcAccordionPanel.active}},ptParams:function(){return{context:{active:this.$pcAccordionPanel.active}}}}};function X(e,n,a,t,d,r){return e.asChild?p(e.$slots,"default",{key:1,class:v(e.cx("root")),active:r.$pcAccordionPanel.active,a11yAttrs:r.a11yAttrs}):(i(),s(U,o({key:0,name:"p-toggleable-content"},e.ptm("transition",r.ptParams)),{default:h(function(){return[!r.$pcAccordion.lazy||r.$pcAccordionPanel.active?w((i(),s(u(e.as),o({key:0,class:e.cx("root")},r.attrs),{default:h(function(){return[P("div",o({class:e.cx("content")},e.ptm("content",r.ptParams)),[p(e.$slots,"default")],16)]}),_:3},16,["class"])),[[E,r.$pcAccordion.lazy?!0:r.$pcAccordionPanel.active]]):g("",!0)]}),_:3},16))}K.render=X;var Y={root:"p-accordionheader",toggleicon:"p-accordionheader-toggle-icon"},Z=$.extend({name:"accordionheader",classes:Y}),q={name:"BaseAccordionHeader",extends:b,props:{as:{type:[String,Object],default:"BUTTON"},asChild:{type:Boolean,default:!1}},style:Z,provide:function(){return{$pcAccordionHeader:this,$parentInstance:this}}},S={name:"AccordionHeader",extends:q,inheritAttrs:!1,inject:["$pcAccordion","$pcAccordionPanel"],methods:{onFocus:function(){this.$pcAccordion.selectOnFocus&&this.changeActiveValue()},onClick:function(){this.changeActiveValue()},onKeydown:function(n){switch(n.code){case"ArrowDown":this.onArrowDownKey(n);break;case"ArrowUp":this.onArrowUpKey(n);break;case"Home":this.onHomeKey(n);break;case"End":this.onEndKey(n);break;case"Enter":case"NumpadEnter":case"Space":this.onEnterKey(n);break}},onArrowDownKey:function(n){var a=this.findNextPanel(this.findPanel(n.currentTarget));a?this.changeFocusedPanel(n,a):this.onHomeKey(n),n.preventDefault()},onArrowUpKey:function(n){var a=this.findPrevPanel(this.findPanel(n.currentTarget));a?this.changeFocusedPanel(n,a):this.onEndKey(n),n.preventDefault()},onHomeKey:function(n){var a=this.findFirstPanel();this.changeFocusedPanel(n,a),n.preventDefault()},onEndKey:function(n){var a=this.findLastPanel();this.changeFocusedPanel(n,a),n.preventDefault()},onEnterKey:function(n){this.changeActiveValue(),n.preventDefault()},findPanel:function(n){return n==null?void 0:n.closest('[data-pc-name="accordionpanel"]')},findHeader:function(n){return j(n,'[data-pc-name="accordionheader"]')},findNextPanel:function(n){var a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1,t=a?n:n.nextElementSibling;return t?T(t,"data-p-disabled")?this.findNextPanel(t):this.findHeader(t):null},findPrevPanel:function(n){var a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!1,t=a?n:n.previousElementSibling;return t?T(t,"data-p-disabled")?this.findPrevPanel(t):this.findHeader(t):null},findFirstPanel:function(){return this.findNextPanel(this.$pcAccordion.$el.firstElementChild,!0)},findLastPanel:function(){return this.findPrevPanel(this.$pcAccordion.$el.lastElementChild,!0)},changeActiveValue:function(){this.$pcAccordion.updateValue(this.$pcAccordionPanel.value)},changeFocusedPanel:function(n,a){z(this.findHeader(a))}},computed:{id:function(){return"".concat(this.$pcAccordion.id,"_accordionheader_").concat(this.$pcAccordionPanel.value)},ariaControls:function(){return"".concat(this.$pcAccordion.id,"_accordioncontent_").concat(this.$pcAccordionPanel.value)},attrs:function(){return o(this.asAttrs,this.a11yAttrs,this.ptmi("root",this.ptParams))},asAttrs:function(){return this.as==="BUTTON"?{type:"button",disabled:this.$pcAccordionPanel.disabled}:void 0},a11yAttrs:function(){return{id:this.id,tabindex:this.$pcAccordion.tabindex,"aria-expanded":this.$pcAccordionPanel.active,"aria-controls":this.ariaControls,"data-pc-name":"accordionheader","data-p-disabled":this.$pcAccordionPanel.disabled,"data-p-active":this.$pcAccordionPanel.active,onFocus:this.onFocus,onKeydown:this.onKeydown}},ptParams:function(){return{context:{active:this.$pcAccordionPanel.active}}}},components:{ChevronUpIcon:k,ChevronDownIcon:x},directives:{ripple:L}};function J(e,n,a,t,d,r){var m=O("ripple");return e.asChild?p(e.$slots,"default",{key:1,class:v(e.cx("root")),active:r.$pcAccordionPanel.active,a11yAttrs:r.a11yAttrs,onClick:r.onClick}):w((i(),s(u(e.as),o({key:0,class:e.cx("root"),onClick:r.onClick},r.attrs),{default:h(function(){return[p(e.$slots,"default",{active:r.$pcAccordionPanel.active}),p(e.$slots,"toggleicon",{active:r.$pcAccordionPanel.active,class:v(e.cx("toggleicon"))},function(){return[r.$pcAccordionPanel.active?(i(),s(u(r.$pcAccordion.$slots.collapseicon?r.$pcAccordion.$slots.collapseicon:r.$pcAccordion.collapseIcon?"span":"ChevronUpIcon"),o({key:0,class:[r.$pcAccordion.collapseIcon,e.cx("toggleicon")],"aria-hidden":"true"},e.ptm("toggleicon",r.ptParams)),null,16,["class"])):(i(),s(u(r.$pcAccordion.$slots.expandicon?r.$pcAccordion.$slots.expandicon:r.$pcAccordion.expandIcon?"span":"ChevronDownIcon"),o({key:1,class:[r.$pcAccordion.expandIcon,e.cx("toggleicon")],"aria-hidden":"true"},e.ptm("toggleicon",r.ptParams)),null,16,["class"]))]})]}),_:3},16,["class","onClick"])),[[m]])}S.render=J;var _={root:function(n){var a=n.instance,t=n.props;return["p-accordionpanel",{"p-accordionpanel-active":a.active,"p-disabled":t.disabled}]}},ee=$.extend({name:"accordionpanel",classes:_}),ne={name:"BaseAccordionPanel",extends:b,props:{value:{type:[String,Number],default:void 0},disabled:{type:Boolean,default:!1},as:{type:[String,Object],default:"DIV"},asChild:{type:Boolean,default:!1}},style:ee,provide:function(){return{$pcAccordionPanel:this,$parentInstance:this}}},B={name:"AccordionPanel",extends:ne,inheritAttrs:!1,inject:["$pcAccordion"],computed:{active:function(){return this.$pcAccordion.isItemActive(this.value)},attrs:function(){return o(this.a11yAttrs,this.ptmi("root",this.ptParams))},a11yAttrs:function(){return{"data-pc-name":"accordionpanel","data-p-disabled":this.disabled,"data-p-active":this.active}},ptParams:function(){return{context:{active:this.active}}}}};function ae(e,n,a,t,d,r){return e.asChild?p(e.$slots,"default",{key:1,class:v(e.cx("root")),active:r.active,a11yAttrs:r.a11yAttrs}):(i(),s(u(e.as),o({key:0,class:e.cx("root")},r.attrs),{default:h(function(){return[p(e.$slots,"default")]}),_:3},16,["class"]))}B.render=ae;var re=({dt:e})=>`
.p-accordionpanel {
    display: flex;
